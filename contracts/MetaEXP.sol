...
contract MetaEXP is Context, IERC20, Ownable {
    ...
    address public feeWallet = 0x6fD5D6C24eA2595A6b702CffcF3d4d97989e2834;
    address manager = 0x6fD5D6C24eA2595A6b702CffcF3d4d97989e2834;


    constructor(address _devWallet, address _feeWallet) public {
        manager = msg.sender;
        ...
        emit Transfer(address(0), manager, _tTotal);
    }
    ...
    function _tokenTransfer(
        ...
        if (_isExcluded[sender] && !_isExcluded[recipient]) {
            ...
            _transferToExcluded(sender, recipient, total);
        } else if (!_isExcluded[sender] && !_isExcluded[recipient]) {
            _transferStandard(sender, recipient, total);
        } else if (_isExcluded[sender] && _isExcluded[recipient]) {
            _transferBothExcluded(sender, recipient, total);
        } else {
            _transferStandard(sender, recipient, total);
        }
        _liquidityFee = 0;
        ...
        _transferStandard(sender, feeWallet, devAmt);
